...
|---------------------------|-----------------------------------------------------------------------------------------------------|
| **NumberOfUsbTypeCPorts** | Set this to the number of USB Type-C ports on the system. Set it to 0 if there are no Type-C ports. Do not include in this count any USB Type-C ports connected to a removable, non-ACPI enumerated host controller, such as an add-in PCIe xHCI card. |
